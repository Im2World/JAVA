...
실습2) 20150112(아무 특정일자나)의 모든 종목을 추출하여 파일을 만드시오, 실습 별 하나(★)
 */

public class p11_2_samsungStockData {
	...
	public static void k38_FileHandling() throws IOException {
		...
		File k38_f1 = new File("C:\\Users\\kopo\\Desktop\\javaProTest\\A005930_20150112.csv");	// A005930_20150112.csv파일로 저장할 것.
		...
		while ((k38_readtxt = k38_br.readLine()) != null) { //k38_br을 한줄 씩 읽어 k38_readtxt에 저장 
			...
			if (k38_field[1].contains("20150112")) {// 주식영업일자 (k38_field[1])에 20150112가 포함되어 있다면
